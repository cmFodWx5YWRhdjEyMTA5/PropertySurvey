...
import com.softminesol.locations.locationmanager.location.BaseLocationActivity;
...
public abstract class AppBaseActivity<T extends IPresenter> extends BaseLocationActivity implements IActivityView {
    ...
    public ProgressDialog showProgressBar() {
        return showProgressBar("Please Wait");
    }
    ...
    public void onLocationChanged(Location location) {
        ((ILocationRouter)AppBaseApplication.getApplication()).onLocationChanged(location,this);
    }
