...
import com.softminesol.survey_framework.roomDb.Type;
...
public class SurveyOptionCacheDataSource {
    ...
    public Observable<com.softminesol.survey_framework.survey.common.model.newmodel.ConstructionType> getConstructionType() {
        ...
        com.softminesol.survey_framework.survey.common.model.newmodel.ConstructionType propertyTypes = null;
        if(type!=null) {
            propertyTypes = GsonFactory.getGson().fromJson(type.getJson(), com.softminesol.survey_framework.survey.common.model.newmodel.ConstructionType.class);
        }
        return Observable.just(propertyTypes);
    }
    ...
    public void saveConstructionType(com.softminesol.survey_framework.survey.common.model.newmodel.ConstructionType propertyTypes) {
        String json = GsonFactory.getGson().toJson(propertyTypes);
        Type type = new Type();
        type.setJson(json);
