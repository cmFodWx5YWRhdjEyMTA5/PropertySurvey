...
public class NewSurveyModule {
    ...
    @Provides
    IApartmentSurveyFormSaveRepository getSaveSurveyOptionRepository(com.softminesol.propertysurvey_qc.qasearch.apartmentEntry.data.repository.datasource.SubmitFormDataFactory submitFormDataFactory) {
