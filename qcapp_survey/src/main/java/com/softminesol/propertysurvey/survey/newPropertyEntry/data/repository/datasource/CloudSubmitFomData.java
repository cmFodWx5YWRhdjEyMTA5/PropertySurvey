...
public class CloudSubmitFomData {
    ...
    public Observable<GetPropertySaveResponse> submitCloudNewProperty(String id,SavePropertyRequest formData) {
        return newServeyAPI.submitNewProperty(id,formData).map(new Func1<Response<DataResponse<GetPropertySaveResponse>>, GetPropertySaveResponse>() {
            @Override
