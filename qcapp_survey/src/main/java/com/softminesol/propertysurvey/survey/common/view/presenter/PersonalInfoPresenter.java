...
public class PersonalInfoPresenter extends AppBasePresenter<PersonalInfoContract.View> implements PersonalInfoContract.Presenter {
    ...
    public void setOwnerDetails(Owner ownerDetails) {
        ...
        getView().setEmail(ownerDetails.getEmail());
        getView().setAdharId(ownerDetails.getAadharId());
        getView().setMobileNo(ownerDetails.getMobileNo());
        getView().setBuildingName(ownerDetails.getBuildingName());
        getView().setStreet(ownerDetails.getStreet());
        getView().setColony(ownerDetails.getColony());
        getView().setPincode(ownerDetails.getPincode());
        getView().setWardNumber(ownerDetails.getWardNo());
        fileUrls = (ArrayList<String>) ownerDetails.getRegistryImage();
        filePaths = (ArrayList<String>) ownerDetails.getRegistryImagePath();
    }
}
