...
public class NewPropertyInfoFragment extends PropertyInfoFragment implements NewPropertyInforFragmentContract.View {
    ...
    NewSurveyComponent surveyComponent;// = new ArrayAdapter(getContext(), in.healthhunt.framework.R.layout.dropdown_item);
    ...
    public void setGisId(String gsid) {
        edtGSID.setText(gsid);
    }
    @Override
