package com.softminesol.propertysurvey_qc.survey.newPropertyEntry.di;
...
import com.softminesol.propertysurvey_qc.survey.apartmentEntry.data.repository.ApartmentSurveyFormSubmitRepository;
import com.softminesol.propertysurvey_qc.survey.apartmentEntry.domain.IApartmentSurveyFormSaveRepository;
import com.softminesol.propertysurvey_qc.survey.newPropertyEntry.data.net.NewServeyAPI;
import com.softminesol.propertysurvey_qc.survey.newPropertyEntry.data.repository.SurveyFormSubmitRepository;
import com.softminesol.propertysurvey_qc.survey.newPropertyEntry.data.repository.datasource.SubmitFormDataFactory;
import com.softminesol.propertysurvey_qc.survey.newPropertyEntry.domain.ISurveyFormSaveRepository;
import com.softminesol.propertysurvey_qc.survey.newPropertyEntry.domain.ISurveyFormSubmitRepository;
...
public class NewSurveyModule {
    ...
    @Provides
    com.softminesol.propertysurvey_qc.survey.apartmentEntry.data.net.NewServeyAPI provideLoginApii(Retrofit retrofit) {
        return retrofit.create(com.softminesol.propertysurvey_qc.survey.apartmentEntry.data.net.NewServeyAPI.class);
    }


    @Provides
    IApartmentSurveyFormSaveRepository getSaveSurveyOptionRepository(com.softminesol.propertysurvey_qc.survey.apartmentEntry.data.repository.datasource.SubmitFormDataFactory submitFormDataFactory) {
    ...
    @Provides
    ApartmentInfoPresenter getApartmentPresenter (AdapterFactory adapterFactory,
