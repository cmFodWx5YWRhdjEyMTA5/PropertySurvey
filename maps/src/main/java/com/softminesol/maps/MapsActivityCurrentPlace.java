...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    public void setmToolbar(boolean needBackButton) {
        mToolbar = (Toolbar) findViewById(in.healthhunt.framework.R.id.toolbar);
        if (mToolbar != null) {
            setSupportActionBar(mToolbar);
            if (needBackButton) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    mToolbar.setNavigationIcon(getResources().getDrawable(in.healthhunt.framework.R.drawable.back_arrow, null));
                } else {
                    mToolbar.setNavigationIcon(getResources().getDrawable(in.healthhunt.framework.R.drawable.back_arrow));
                }
